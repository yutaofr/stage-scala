...
## Jour 3 — Consumers & Commit d'Offsets
**Cours (2h)** : Consumer loop, consumer groups et commit d'offsets. Fonctionnement avec le client Kafka Java natif pour rendre les garanties visibles.
...
**TP (4h)** : Le moteur v3.0 consomme un flux Kafka en temps réel, traite les virements au fil de l'eau, et publie les résultats. Démonstration live : lancer le producer et observer les résultats apparaître.
